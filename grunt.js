...
module.exports = function(grunt) {
	...
	grunt.initConfig({
		...
		copy: {
			...
			images: {
				files: {
					'dist/img': ['lib/bootstrap/img/**', 'src/img/**']
				}
			},
			zipsrc: {
				options: {
	...
	// Default task.
	grunt.registerTask('default', 'lint qunit clean:dist copy:fuelux recess copy:images min copy:zipsrc compress clean:zipsrc');
