...
2. Use a single css tag ***after Bootstrap and Fuel UX styles***:
	...
	```
    <link href="http://www.fuelcdn.com/fuelux-mctheme/1.5.4/css/fuelux-mctheme.min.css" rel="stylesheet" type="text/css"/>
    ```
...
1. [CDN](http://www.fuelcdn.com/fuelux-mctheme/1.5.4/css/fuelux-mctheme.min.css)
1. [Zip](http://www.fuelcdn.com/fuelux-mctheme/1.5.4/fuelux.zip)
2. Clone git repo:
   ```
